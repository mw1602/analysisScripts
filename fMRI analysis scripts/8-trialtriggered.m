...
figure()
[averaged_leftmotor] = averageData(lm_epoched);

%deconvolution

[betas_lm] = deconvolveData(lm_timeSeries);

%fit the data

[betas_fitted_lm, design_lm, epochMatrix_lm] = convolveFit(lm_timeSeries);
...
writeNifti('lm_tmap_1.nii', t_values, dataHeader);
writeNifti('lm_pmap_1.nii', parameter_estimates, dataHeader);
writeNifti('lm_pmap_1.nii', p_values, dataHeader);
writeNifti('lm_parameters_1.nii', parameter_estimates, dataHeader);
clear p_values
...
% %trial triggered average
% 
% [averaged_rightmotor] = averageData(rm_epoched);
% 
% %deconvolution
% 
% [betas_rm] = deconvolveData(rm_timeSeries);
% 
% %fit the data
% 
% 
...
% %trial triggered average
% 
% [averaged_leftcalc] = averageData(lc_epoched);
% 
% %deconvolution
% 
% [betas_lc] = deconvolveData(lc_timeSeries);
% 
% %fit the data
% 
...
% %trial triggered average
% 
% [averaged_rightcalc] = averageData(rc_epoched);
% 
% %deconvolution
% 
% [betas_rc] = deconvolveData(rc_timeSeries);
% 
% %fit the data
% 
